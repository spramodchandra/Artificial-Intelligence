        ...
        for a in spla:
            ...
            if not(a in commonDomain):
                ...
                if my_hash in dic_efficiency:
                    ...
                    if lvl==0:
                        print splaEfficiency,lahsaEfficiency,a,sel
                if splaEfficiency>maxEfficiency:
...
def Game(turn=0):
    ...
    splaEfficiency,lahsaEfficiecy,c_id,c_list=PlayGame(spla,lahsa,turn,parking,beds,spla_choose,lahsa_choose,0)
    print "final"
    print splaEfficiency,lahsaEfficiecy, c_id,c_list
    days=0
    for a in c_list:
        days+=sum(candidates.get(a))
